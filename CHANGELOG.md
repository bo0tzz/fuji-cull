...
## [1.9.0](https://github.com/bo0tzz/fuji-cull/compare/v1.8.0...v1.9.0) (2026-08-25)


### Features

* add fuji-cull web ui for culling photos straight off the camera ([be6cbc7](https://github.com/bo0tzz/fuji-cull/commit/be6cbc7c1ad86701715062dd3c31db9372a4bbeb))
* add native sdl frontend with libjpeg-turbo multicore decode ([90af28d](https://github.com/bo0tzz/fuji-cull/commit/90af28d1650fa19398dbce46b2ff734e70697a31))
* aft patch gains --device-fd for android usb host api ([56150aa](https://github.com/bo0tzz/fuji-cull/commit/56150aaffbc5fe3bd0cb055f56ee007550987871))
* android app + hardware video decode & perf ([68547c0](https://github.com/bo0tzz/fuji-cull/commit/68547c0483d7b86c4e9fad5b88ac4cb0d0f16e9f))
* android app scaffold — kotlin/compose culling mvp ([bf6401d](https://github.com/bo0tzz/fuji-cull/commit/bf6401d61102bca114801f00d8d89a982d2b9f13))
* android groundwork — usb fd plumbing and gomobile facade ([c881ed9](https://github.com/bo0tzz/fuji-cull/commit/c881ed9db366c0432bf5715bce600b1a47ddc61d))
* android usb diagnostics on connect screen, ptp interface claim, detach handling ([28334dc](https://github.com/bo0tzz/fuji-cull/commit/28334dcecdac35f3a5ceb8942c8c3381c1da86bd))
* **android:** design-system pass — tokens, tile grammar, no session field ([6b45de5](https://github.com/bo0tzz/fuji-cull/commit/6b45de591541d2deba0f2cb66601007410545aea))
* badge shots already uploaded to immich ([93a1b5d](https://github.com/bo0tzz/fuji-cull/commit/93a1b5dddb5eb295d8e622a23ec22ca9ae80d814))
* camera stale-buffer breaker indicator in both headers ([bef3fa1](https://github.com/bo0tzz/fuji-cull/commit/bef3fa12a479b956c940d657148e11b435e2710d))
* **camera:** make a PTP refusal say why ([78fadd2](https://github.com/bo0tzz/fuji-cull/commit/78fadd2420c2b0c7323cebb373423e586ee42422))
* connectivity — cross-device sync + remote camera host (combined) ([3bea980](https://github.com/bo0tzz/fuji-cull/commit/3bea9803e4d0699470f93fedd0182f5f5c382612))
* **desktop:** design-system pass — tokens and tile grammar in SDL ([49fbffb](https://github.com/bo0tzz/fuji-cull/commit/49fbffb0300722155e976d8ca81ca716d6cb3340))
* **engine:** remember Immich credentials and read them at startup ([161e098](https://github.com/bo0tzz/fuji-cull/commit/161e0989fee9333afc6033055194ed54085cd94e))
* **engine:** screen-sized previews and per-shot focus scoring ([75fea24](https://github.com/bo0tzz/fuji-cull/commit/75fea2458880d180651ef234af730ddd58cfe705))
* exif orientation store with rotated thumbnail delivery ([7e5603c](https://github.com/bo0tzz/fuji-cull/commit/7e5603c81a626829b21623d7131843017f3aa42a))
* fuji-cull identity — one generated mark, applied everywhere ([60dbcbe](https://github.com/bo0tzz/fuji-cull/commit/60dbcbe35abab5fe3c7fe710fbbbd02361b829df))
* generate missing thumbnails locally from buffered full images ([559e3ff](https://github.com/bo0tzz/fuji-cull/commit/559e3ffccc778e1a5439ea811bc09b2d14aa7e42))
* gui feature parity - embedded mpv video, grid view, import panel ([7ba1c00](https://github.com/bo0tzz/fuji-cull/commit/7ba1c003340bb46cf969f5e37476823e2b8fb319))
* **gui:** focus peaking overlay and burst-sharpest marker ([82c886e](https://github.com/bo0tzz/fuji-cull/commit/82c886e08a33ac46ee57c46631cef80b96f0d188))
* **gui:** in-app settings screen for Immich credentials ([acbbca9](https://github.com/bo0tzz/fuji-cull/commit/acbbca983ebe6c6df7f1c99201422f440cef0547))
* **gui:** write the log to a file ([7e59cf3](https://github.com/bo0tzz/fuji-cull/commit/7e59cf3d89d98c3e0100b3c59ff3a0096f62f439))
* head sweep is the primary thumbnail path ([2da444a](https://github.com/bo0tzz/fuji-cull/commit/2da444ac9fbb3e4a43830e0d3c8f05893e016c30))
* heal camera-impossible thumbs from exif-embedded previews ([06d0b77](https://github.com/bo0tzz/fuji-cull/commit/06d0b7769e1c9f84ce8f0fb692dd7889ce3d971c))
* **immich:** send the file checksum with each upload ([281e07e](https://github.com/bo0tzz/fuji-cull/commit/281e07e732cf153273464bddef1502cce0347f21))
* **import:** draw the desktop import panel as stage lanes ([436f850](https://github.com/bo0tzz/fuji-cull/commit/436f8507ed292ff63e9b9b340adc26cb6bbefa0c))
* **import:** draw the web import panel as stage lanes ([ebcebfa](https://github.com/bo0tzz/fuji-cull/commit/ebcebfa08576bc9c50f05cf62aff733fc8b7bbfb))
* **import:** overlap the camera copy with hashing and upload ([b7df7df](https://github.com/bo0tzz/fuji-cull/commit/b7df7df0d5e98d4332cbe6abc038e97288950a9c))
* **import:** per-file upload progress and rate ([1aa18bc](https://github.com/bo0tzz/fuji-cull/commit/1aa18bcae94a05aa52626a233356ef5750a1cde8))
* **import:** report progress per stage instead of one active phase ([0113df3](https://github.com/bo0tzz/fuji-cull/commit/0113df364dee4cf9015aa015c6311bf3193c6e28))
* **import:** stage lanes in the Android import dialog ([42bbdbe](https://github.com/bo0tzz/fuji-cull/commit/42bbdbebb0552ec490e49c7a727ebe2e5433e47c))
* **import:** treat "keep" as a queue so a finished event stays finished ([1e1cd41](https://github.com/bo0tzz/fuji-cull/commit/1e1cd416f56f606f930fbf3bf29c54910dad4e9c))
* iOS app (simulator) — SwiftUI culling client over the gomobile engine ([4fe1dd7](https://github.com/bo0tzz/fuji-cull/commit/4fe1dd7dd00111a72160054421600e3a6b24aa3b))
* **ios:** client-side video posters — full port of the Android mechanism ([c4d39c9](https://github.com/bo0tzz/fuji-cull/commit/c4d39c90c8fe2ce5dac48c90a294240f2678af24))
* **ios:** design-system foundation — tokens, IBM Plex, the new tile ([8cca68b](https://github.com/bo0tzz/fuji-cull/commit/8cca68b83eeae3c686c89caf671fe499544294cc))
* **ios:** design-system screens — viewer, video, connect, import, settings ([0c21a20](https://github.com/bo0tzz/fuji-cull/commit/0c21a20cca21b34f215b4509b8f322ef1c04244a))
* **ios:** ImageCaptureCore camera link and full Android feature parity ([f94c2c5](https://github.com/bo0tzz/fuji-cull/commit/f94c2c592f99023b8d2e4a3258a79726dd088d2a))
* **ios:** index over our own PTP sweeps — ready in ~3min, not ~5 ([5f01b43](https://github.com/bo0tzz/fuji-cull/commit/5f01b433ab19637776ce09df38988db99aa27ab6))
* **ios:** instant photo cuts in the viewer (no swipe animation) ([44f7a3f](https://github.com/bo0tzz/fuji-cull/commit/44f7a3fe8e0f5b0d4c65500bd219000832ef33ff))
* **ios:** make-ipa.sh — unsigned release ipa for sideload distribution ([97f4c64](https://github.com/bo0tzz/fuji-cull/commit/97f4c641aafa77ac20558e5ac127c454fbac278e))
* **ios:** real date scrubber on the timeline — the Android rail, ported ([8537378](https://github.com/bo0tzz/fuji-cull/commit/8537378e5056e58695611820912af0fa57ed88f5))
* **ios:** real-camera link over ImageCaptureCore's object API ([7b8d348](https://github.com/bo0tzz/fuji-cull/commit/7b8d348891e9bc5071f3588a50c90e5c95df29f2))
* **ios:** self-serve debug probe + fix 3s startup hang at 24k shots ([0d3418c](https://github.com/bo0tzz/fuji-cull/commit/0d3418cba456cacc24a0ca4e343eee2b7aa728a9))
* **ios:** SideStore source feed template; ignore dist/ ([e4a94c3](https://github.com/bo0tzz/fuji-cull/commit/e4a94c30071ac854ca51a181e0aba685abb53c48))
* **ios:** stage lanes in the import sheet ([8a08eae](https://github.com/bo0tzz/fuji-cull/commit/8a08eae278c2ee3630e60e750591b1afa9f49ccd))
* **ios:** video streaming for 4:2:0 AND 4:2:2 — libmpv, as on Android ([6b808ba](https://github.com/bo0tzz/fuji-cull/commit/6b808ba490b078f5cba90eba345f2be4560de79c))
* large preemptible image batches ([2aa621a](https://github.com/bo0tzz/fuji-cull/commit/2aa621a3c702f9de0447ebf53f7974a75800d327))
* larger forward-biased decode buffer, tunable via flags ([d0f747c](https://github.com/bo0tzz/fuji-cull/commit/d0f747cc69d3d4eebc100ddc18e041c9f03876ff))
* log video decode path (hwdec vs software fallback) ([bbdc2df](https://github.com/bo0tzz/fuji-cull/commit/bbdc2df23241d3b20a306712c404860379bdcb8c))
* macos app bundle dmg ([#5](https://github.com/bo0tzz/fuji-cull/issues/5)) ([344e5b2](https://github.com/bo0tzz/fuji-cull/commit/344e5b2750b99e3f27ad005d9831dc03485f0c79))
* macos builds ([#4](https://github.com/bo0tzz/fuji-cull/issues/4)) ([28423ad](https://github.com/bo0tzz/fuji-cull/commit/28423ad0ab8d28416b5a729c4471bcdea315dc8c))
* metadata coverage counter in both headers ([cbeb2f1](https://github.com/bo0tzz/fuji-cull/commit/cbeb2f1b8a8d5b1a7ae303951f6a807069454300))
* partial-read breaker self-probes every 3 minutes ([25da6d4](https://github.com/bo0tzz/fuji-cull/commit/25da6d4b849dec35b207e9acad4bd1a0c0d1c5f9))
* per-camera sessions — decisions follow the camera, not a name ([ad20605](https://github.com/bo0tzz/fuji-cull/commit/ad206055f6e8cb4486a63c602bee676bd3dc4be4))
* persist camera-impossible thumbnail set across restarts ([1c8c802](https://github.com/bo0tzz/fuji-cull/commit/1c8c80237fb48aa9508d1f9a7fa9b788c06d4855))
* pipelined thumb healing and explicit healing counter in both uis ([1a3d8d4](https://github.com/bo0tzz/fuji-cull/commit/1a3d8d4158cdd2ab0f1f3c32e2942d3929bebe31))
* port fuji-import into fuji-tools module with shared packages ([1dd99fc](https://github.com/bo0tzz/fuji-cull/commit/1dd99fc1237471a545201714942c570a8983a73b))
* preload grid thumbnails beyond the fold ([116a2c9](https://github.com/bo0tzz/fuji-cull/commit/116a2c9d27eae5fc62ccca30bb9a4aa4faec5150))
* pure-go exif restamping and raf preview extraction ([2f23e47](https://github.com/bo0tzz/fuji-cull/commit/2f23e47111cadb7b61698581d6b726006bfb59f0))
* remember import destination and album across sessions ([eafae21](https://github.com/bo0tzz/fuji-cull/commit/eafae2117cecd8e3a6c723784dae3399b5416396))
* **remote:** remote camera host — browse a camera plugged into another machine ([3e193f2](https://github.com/bo0tzz/fuji-cull/commit/3e193f244840ba9c546a0e652ca3cb100b24a383))
* retry discovery until a camera appears ([ed0b574](https://github.com/bo0tzz/fuji-cull/commit/ed0b5749d57629f9648e7a7c83e38ac0ead53241))
* self-contained appimage bundle ([#2](https://github.com/bo0tzz/fuji-cull/issues/2)) ([30344f2](https://github.com/bo0tzz/fuji-cull/commit/30344f2b0509f94e96dc1a920e3cef3f91962f2e))
* stack RAF+JPG pairs in Immich after upload ([#7](https://github.com/bo0tzz/fuji-cull/issues/7)) ([7b0ad61](https://github.com/bo0tzz/fuji-cull/commit/7b0ad612ae77fb22679809b193c775ec0c0a7df5))
* stream videos straight off the camera ([c955e69](https://github.com/bo0tzz/fuji-cull/commit/c955e6977eaef15ae257efa22cff8821e9915e77))
* **sync/1:** device-independent canonical shot key + reverse indexes ([d4dd3c4](https://github.com/bo0tzz/fuji-cull/commit/d4dd3c45fa80e856070117623da5eae97cc8a7cc))
* **sync/2:** session v2 — HLC-LWW records, tombstones, migration, merge ([f88b57e](https://github.com/bo0tzz/fuji-cull/commit/f88b57e12220b4f997931958c5e1a96d26f60ff9))
* **sync/4:** self-hosted sync server + shared merge core ([453c695](https://github.com/bo0tzz/fuji-cull/commit/453c69577d7a166f1c3dc3e3bd58da800861a313))
* **sync/5:** engine sync client — end-to-end convergence ([8a6bbcd](https://github.com/bo0tzz/fuji-cull/commit/8a6bbcd6e4351fadf892701de076f9d48f42bfc7))
* **sync/6a:** engine sync status + web client inbound-apply ([961ed53](https://github.com/bo0tzz/fuji-cull/commit/961ed5342f20a1c42604300c30d398329f5734e2))
* **sync/6b:** per-client sync config + inbound-apply (iOS/Android/desktop) ([31ba8cc](https://github.com/bo0tzz/fuji-cull/commit/31ba8ccc56c83620b0fada0db153a9b1d2fe5942))
* **sync:** cross-platform camera identity + desktop config ([fcc57fa](https://github.com/bo0tzz/fuji-cull/commit/fcc57faec48146df9fd6cf93a58e3cc42be291de))
* video poster thumbnails via mtp partial reads (patched aft-mtp-cli) ([599a0d7](https://github.com/bo0tzz/fuji-cull/commit/599a0d74b64a3d3806b737fd1db228cd0dc2fb93))
* wasd one-handed culling cluster ([b3c9b8f](https://github.com/bo0tzz/fuji-cull/commit/b3c9b8f0abf5975e94bc88ff61cc96561c71952b))
* **web:** design-system pass — tokens, IBM Plex, tile grammar ([ed273e1](https://github.com/bo0tzz/fuji-cull/commit/ed273e107c201fac03e467ffa2af41ac88d1684b))
* zero-copy gl video rendering ([422748b](https://github.com/bo0tzz/fuji-cull/commit/422748bb7fe3fd422694329be2aa68540139d96f))


### Bug Fixes

* adaptive frame cap - throttle only vsync-less spin frames ([87841e7](https://github.com/bo0tzz/fuji-cull/commit/87841e75df21db3b957ea0931efe5f6efeaf76ca))
* android crash on launch — defer connected-device fgs until usb grant ([7479749](https://github.com/bo0tzz/fuji-cull/commit/74797495cf3c227a1d5e7912c89a5ae16b90c942))
* android startup — honor FUJI_AFT in ensure, surface engine errors on screen ([8d5093c](https://github.com/bo0tzz/fuji-cull/commit/8d5093c01b183b7ac54cd0b34cb95e6963bce722))
* **api:** log responses that failed ([bc57809](https://github.com/bo0tzz/fuji-cull/commit/bc578093cb149cae62a4303c2041364f6c26be7a))
* bundle sdl3 for sdl2-compat dlopen in macos app ([fd2d001](https://github.com/bo0tzz/fuji-cull/commit/fd2d001833f8721e3c8b4d04b606049a85ee2595))
* camera-scoped caches; carry-zoom on mobile viewers ([a07286f](https://github.com/bo0tzz/fuji-cull/commit/a07286fc5b0a7e0bd738d828c61a30563513f1c5))
* **camera:** never serve bytes that are not the file that was asked for ([853d29e](https://github.com/bo0tzz/fuji-cull/commit/853d29e27061937827d8785ab0a095e3c82b675d))
* **camera:** stop reusing the camera link while a call is outstanding ([7974987](https://github.com/bo0tzz/fuji-cull/commit/797498746ad31176e97b6f87fde4c042c08f057d))
* cap frame rate (wayland vsync does not block when unfocused) ([d8d7fee](https://github.com/bo0tzz/fuji-cull/commit/d8d7feeea4c7a2a0baa83bf60aef904af70f7904))
* cheap sick-camera probes, auto-reenable partial reads on recovery ([96d8073](https://github.com/bo0tzz/fuji-cull/commit/96d80732cff444f0bb7edddcfc46dd237bd1fbe7))
* chunked, validated, retried import pulls ([6d3bffb](https://github.com/bo0tzz/fuji-cull/commit/6d3bffbde4f524acc8e1d22087ded805c4baee98))
* **ci:** gen-logo vet compliance; 512px desktop icon for linuxdeploy ([89d27de](https://github.com/bo0tzz/fuji-cull/commit/89d27de9d3c4f9a5f507ce04414c2b92331b92a8))
* **ci:** harden xcodegen retries — it SIGABRTs transiently on runners ([2ac9a03](https://github.com/bo0tzz/fuji-cull/commit/2ac9a0388e9695c226aecabeebde53257f2a455b))
* **clients:** stop discarding poll failures ([11b73c9](https://github.com/bo0tzz/fuji-cull/commit/11b73c964c4a4c0997bd3146f5dde5b20aa7c575))
* dereference sdl3 symlink when bundling ([341e25d](https://github.com/bo0tzz/fuji-cull/commit/341e25d7f716e0bac6c6ae4b90df2ac2a6138e97))
* detect fragment thumbnails (soi check), heal via full-image pulls + local generation ([705896d](https://github.com/bo0tzz/fuji-cull/commit/705896de093d69ec4c1caee0099ebc5298d7d1ae))
* exif orientation normalization in turbo decode ([595ebca](https://github.com/bo0tzz/fuji-cull/commit/595ebca972b2c0d86843799f49c9fc34e93083d8))
* gomobile getters are methods in kotlin ([eb02f3e](https://github.com/bo0tzz/fuji-cull/commit/eb02f3e58c2d0071a64ba812dc8003212f3a4f28))
* grid scroll fighting cursor snap and thumb draw budget ([3306f11](https://github.com/bo0tzz/fuji-cull/commit/3306f1106e1a20ed2b1e43dfbd05f03826373ac6))
* gui texture thrash strobe and missing disk-buffer indicators ([e688b07](https://github.com/bo0tzz/fuji-cull/commit/e688b073fb95c7105e288f359dd4e4ff5e10ebd4))
* **gui:** scale the import panel's layout offsets ([9fbe317](https://github.com/bo0tzz/fuji-cull/commit/9fbe317889637e7b0ebd91bbd6d8cb171fc9002f))
* import fails fast on all-garbage chunk, trips camera breaker ([42535a9](https://github.com/bo0tzz/fuji-cull/commit/42535a9eca0d601f42e9b4f48cd9c43cb0358d8a))
* **import:** let a failed upload-only import resume instead of re-pulling ([6cf37db](https://github.com/bo0tzz/fuji-cull/commit/6cf37db9566ee16b45a2ccd28a911acd98992c68))
* **import:** pull through the persistent partial-read session ([74e3503](https://github.com/bo0tzz/fuji-cull/commit/74e3503e608a9a022e4eddeec07e2ae01561c3cc))
* **ios/remote:** scrubber fling no longer bounces to the connect screen ([36fd8d9](https://github.com/bo0tzz/fuji-cull/commit/36fd8d9bb2e4558152c3240ff1a27c072e8e2d5c))
* **ios:** count video posters in the thumbnail total ([1b1be22](https://github.com/bo0tzz/fuji-cull/commit/1b1be228aa4f41a428b4d24a26f16c4b704002e2))
* **ios:** device bring-up — ICC log routing and correct device targeting ([b851d38](https://github.com/bo0tzz/fuji-cull/commit/b851d386c5d0a621087024dbcd5df01a866e6632))
* **ios:** kill the black flash between photos (+ video-teardown crash) ([e97f3b7](https://github.com/bo0tzz/fuji-cull/commit/e97f3b7cc022711810402896d91d8d095785e3e2))
* **ios:** open the PTP passthrough — it was gated, not broken ([3393155](https://github.com/bo0tzz/fuji-cull/commit/3393155a5919198239cd652e136600631a2ab7c7))
* **ios:** pan while zoomed instead of paging the viewer ([22f9557](https://github.com/bo0tzz/fuji-cull/commit/22f95572e6c4b406d555a1e65357573f0587a3a6))
* **ios:** video posters render — ThumbView rejected every file:// URL ([000f2c5](https://github.com/bo0tzz/fuji-cull/commit/000f2c577ec2f1bb9e3b52a3885f200a15d4b940))
* **ios:** viewer filmstrip — pinned height, windowed, video posters ([5da50f2](https://github.com/bo0tzz/fuji-cull/commit/5da50f29067649b49ffe1b6af178624754c763a5))
* **ios:** viewer pager — UIPageViewController, swipes land on pages ([51ae69b](https://github.com/bo0tzz/fuji-cull/commit/51ae69b1bb74718db62e35b7542e286f63ebe322))
* **ios:** virtualize the timeline — the 24k-shot freeze was SwiftUI's ([605d117](https://github.com/bo0tzz/fuji-cull/commit/605d1171ba13790c93933b26fff3317b69b9f102))
* keep gl context handle as unsafe.Pointer (go vet) ([c9b982a](https://github.com/bo0tzz/fuji-cull/commit/c9b982ac0294c41b835f696b6b43b4b4c72ff955))
* macos camera daemon contention and false healing accumulation ([be61cc3](https://github.com/bo0tzz/fuji-cull/commit/be61cc3555c65d6d37ac206dd9839d5e2fe52293))
* magic-check bulk transfers, purge and breaker for stale-buffer garbage ([cb2f4a4](https://github.com/bo0tzz/fuji-cull/commit/cb2f4a442e696e992011b9ae0ac9aab64907868f))
* modern immich api routes (v1.106+/v2/v3 plural endpoints) ([b87b686](https://github.com/bo0tzz/fuji-cull/commit/b87b68646ec716c361244f7913f9ea84600ccb7b))
* mpv hwdec copy-back and fast sw scaling for smooth embedded video ([d16cda6](https://github.com/bo0tzz/fuji-cull/commit/d16cda6f0c1728eacbde25fb7a2305249f8d4d3b))
* park render loop in waiteventtimeout when vsync is not blocking ([deb5b69](https://github.com/bo0tzz/fuji-cull/commit/deb5b69024ef1babccbfa7a48958ed6beb47c177))
* pass native display for zero-copy interop, correct fbo flip ([a7bc9c5](https://github.com/bo0tzz/fuji-cull/commit/a7bc9c56c64436c6db6c6a3d7cd5903f10b08ce9))
* prefer native wayland sdl driver for egl (zero-copy needs it) ([b6ef89c](https://github.com/bo0tzz/fuji-cull/commit/b6ef89cfd99a1d4bba759c8319803a85d493579d))
* reliable X-H2S camera video streaming and macOS preemption ([#15](https://github.com/bo0tzz/fuji-cull/issues/15)) ([6795815](https://github.com/bo0tzz/fuji-cull/commit/679581532204b02dee0b46bec8002bca25a4e2e2))
* render in physical pixels (macos retina), ctrl +/- ui zoom ([f9b2cfc](https://github.com/bo0tzz/fuji-cull/commit/f9b2cfc53ac70f915e7909e4cf8e7393ec5fc042))
* reprobe sick camera every 20s instead of 3 minutes ([942b183](https://github.com/bo0tzz/fuji-cull/commit/942b1836d31304cb9c53a30e6ce432920581bffb))
* ship sdl3 under the unversioned name sdl2-compat dlopens ([f0b19a5](https://github.com/bo0tzz/fuji-cull/commit/f0b19a5b25fcc283d0c4844392909c4970f4977d))
* suspend photo texture uploads during video playback ([4fb3a56](https://github.com/bo0tzz/fuji-cull/commit/4fb3a56162d24f2463fe3d0a45ff051ec480f3a4))
* swallow the ghost TEXTINPUT from the keypress that opens the import panel ([#11](https://github.com/bo0tzz/fuji-cull/issues/11)) ([86702c5](https://github.com/bo0tzz/fuji-cull/commit/86702c5482c01de506ce866e5d99fef164cc8f0f))
* thumb texture cache larger than a fullscreen 4k grid ([f57da44](https://github.com/bo0tzz/fuji-cull/commit/f57da449e2b4307710c4e5c0a82915be7c4e1370))
* tighten head/poster batch timeouts so usb wedges cost seconds ([82182b5](https://github.com/bo0tzz/fuji-cull/commit/82182b51318ff05bde451d9849fe2c4665eaa65c))
* timeout on image fetches - wedged usb transfer froze the pipeline ([292a8d5](https://github.com/bo0tzz/fuji-cull/commit/292a8d54c68464eae07e0328acae659a74d07b90))
* validate jpeg completeness before banking thumbnails, purge truncated cache ([983b0af](https://github.com/bo0tzz/fuji-cull/commit/983b0af9df9b7ceb18970b0f6436d86e7b8ae640))


### Performance Improvements

* 256-shot orientation batches to amortize session setup ([a6984b8](https://github.com/bo0tzz/fuji-cull/commit/a6984b89725416aebf83cc4a6c2cbef2650f7306))
* batch video poster head pulls, parallel ffmpeg extraction ([454a087](https://github.com/bo0tzz/fuji-cull/commit/454a0876583763f7d70a96ad555f69ff341ea485))
* **ios:** photo thumbs at poster speed — raw serving, metadata rotation ([8958fce](https://github.com/bo0tzz/fuji-cull/commit/8958fced95e8be2c2f0d5b97ed0168a595ad9376))
* **ios:** real viewer buffering, plus focus peaking and a portrait fix ([1b09c0d](https://github.com/bo0tzz/fuji-cull/commit/1b09c0dbf1d0d81034e5c3f89b51a0d166b763d1))
